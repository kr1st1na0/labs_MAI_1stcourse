...
## 2. Цель работы
Составить программу выполнения заданных действий над файлами на одном из интерпретируемых командных языков OC UNIX (Shell, Cshell, Bash, ...), согласованном с преподавателем.
## 3. Задание (вариант № 2)
...
<b>Утилиты операционной системы:</b> echo, read, find, stat, cat
