...
Отчет сдан «24» сентября 2022 г., итоговая оценка ______
...
Утилиты операционной системы: cd, pwd, ls, cp, mv, mkdir, rmdir, cat, man, ps, rm
Прикладные системы и программы: gnuplot
...
```
## 11. Выводы
Выяснила, что в OC UNIX есть множество полезных утилит, которые облегчают работу в этой системе. Я изучила некоторые из них. Освоила навигацию в файловой системе, создание, удаление файлов и директорий, а также приобрела навыки, которые помогут выполнять другие лабораторные работы.
