...
<b>Система программирования:</br> не использовалась<br/>

<b>Редактор текстов:</b> emacs версия 25.2.2<br/>

<b>Утилиты операционной системы:</b> cd, pwd, ls, cp, mv, mkdir, rmdir, cat, man, ps, rm<br/>

<br>Прикладные системы и программы:</br> gnuplot<br/>

<br>Местонахождение и имена файлов программ и данных на домашнем компьютере:</br> /home/kristina<br/>
